export default function Collection(){
    return(
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          <div className="w-full">
            <img src="pic2.jpg" alt="Product 1"
              className="w-full object-cover object-top aspect-[230/307]" />
          </div>
        ...
        <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          <div className="w-full">
            <img src="pic3.jpg" alt="Product 1"
              className="w-full object-cover object-top aspect-[230/307]" />
          </div>
        ...
        <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          <div className="w-full">
            <img src="pic4.jpg" alt="Product 1"
              className="w-full object-cover object-top aspect-[230/307]" />
          </div>
        ...
        <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          <div className="w-full">
            <img src="pic5.jpg" alt="Product 1"
              className="w-full object-cover object-top aspect-[230/307]" />
          </div>
        ...
        <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          <div className="w-full">
            <img src="pic6.jpg" alt="Product 1"
              className="w-full object-cover object-top aspect-[230/307]" />
          </div>
        ...
        <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          <div className="w-full">
            <img src="pic7.jpg" alt="Product 1"
              className="w-full object-cover object-top aspect-[230/307]" />
          </div>
        ...
        <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          <div className="w-full">
            <img src="pic8.jpg" alt="Product 1"
              className="w-full object-cover object-top aspect-[230/307]" />
          </div>
